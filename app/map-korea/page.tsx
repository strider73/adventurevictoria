...
import { Navbar, Footer, SocialIcons, Button, Badge, NotificationBadge, FeedbackButtons, getVisitorId } from "@/components/ui";
...
type CategoryType = "all" | "Mountain" | "Festival" | "Food Tour" | "National Park" | "Nature" | "Fishing" | "Beach" | "Valley" | "Camping" | "Urban" | "Temple" | "Waterfall" | "Cultural" | "Garden" | "Glamping" | "Trail" | "Scenic Drive" | "Cafe" | "Island";
...
function MapKoreaPageContent() {
  ...
  const orderedCategories: CategoryType[] = [
    "Festival", "Food Tour", "Cafe", "Island", "Mountain", "National Park", "Nature", "Fishing",
