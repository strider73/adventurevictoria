...
const wireframeOptions = [
  {
    id: 1,
    title: "Map-First Split View",
    description: "Equal prominence for interactive map and video content with adventure stats overlay.",
    file: "user-profile/map-first-split-view.html",
    preview: "/wireframes/user-profile/map-first-split-view-preview.png",
    features: [
      "Compact hero with avatar",
      "50/50 split layout (map + videos)",
      "Adventure stats overlay on map",
      "Video grid with location tags",
      "Filter tabs for content",
    ],
    newComponents: ["MapView", "StatsCard", "FilterTabs", "VideoCard"],
    badge: "Map Focus",
    badgeVariant: "info" as const,
  },
  {
    id: 2,
    title: "Content Grid with Map Sidebar",
    description: "Traditional video-first layout with persistent map sidebar for location filtering.",
    file: "user-profile/content-grid-map-sidebar.html",
    preview: "/wireframes/user-profile/content-grid-map-sidebar-preview.png",
    features: [
      "Full hero section",
      "Stats cards row",
    ...
    newComponents: ["StatsCard", "FilterTabs", "VideoCard", "MapView", "LocationList"],
    badge: "Content First",
    badgeVariant: "success" as const,
  },
  {
    id: 3,
    title: "Map-Dominant Hero with Timeline",
    description: "Immersive map experience with chronological video timeline showing adventure progression.",
    file: "user-profile/map-dominant-hero-timeline.html",
    preview: "/wireframes/user-profile/map-dominant-hero-timeline-preview.png",
    features: [
      "Large hero map with overlay",
      "Map controls and filters",
      "Chronological video timeline",
      "Category filter chips",
      "View toggle (Timeline/Grid/List)",
    ],
    newComponents: ["MapView", "MapControls", "StatsCard", "FilterTabs", "VideoCard"],
    badge: "Timeline",
    badgeVariant: "warning" as const,
  },
];

export default function UserProfileWireframesPage() {
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-[--color-text-secondary] max-w-2xl mx-auto text-lg">
            Explore three different layout options for the creator/user profile page.
            Each wireframe shows how users can view their adventure map, videos, and stats.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[--color-bg-secondary]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {["Navbar", "Footer", "Button", "Badge", "Card", "Hero"].map((component) => (
              <div
                key={component}
