...
const navLinks = [
  ...
  { label: "Test Map", href: "/testmap", isActive: true },
...
function TestMapPageContent() {
  ...
  useEffect(() => {
    ...
    if (selectedVideo) {
      ...
      } else if (selectedVideo.youtubeId) {
  ...
  useEffect(() => {
    if (!selectedVideo || !currentPlayingVideoId || !ytApiReady) {
      return;
    }
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [selectedVideo, currentPlayingVideoId, ytApiReady]);

  // TODO: Replace with fetch from gateway:8030/web-service/api/v1/videos/stats?videoId=xxx
  useEffect(() => {
    ...
    // TODO: Fetch stats from gateway:8030/web-service/api/v1/videos/stats?videoId=${currentPlayingVideoId}
  ...
  // TODO: Replace with POST/DELETE to gateway:8030/web-service/api/v1/videos/report
  ...
  // Enrich locations with displayThumbnailId and community video count
  ...
  // Sort locations: videos first, then by votes
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[--color-brand]/10 text-[--color-brand] text-sm font-medium mb-4">
              ...
              <div className="flex items-center gap-2 mt-3 flex-wrap">
                ...
                <button
                  onClick={() => {
                    ...
                    const shareUrl = `${window.location.origin}/testmap?site=${selectedVideo.id}${videoParam}${timeParam}`;
